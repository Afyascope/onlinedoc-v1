...
const navConfig: Record<UserRole, NavItem[]> = {
  patient: [
    ...
    { label: "Library", href: "/dashboard/patient/library", icon: <IconBooks size={20} /> },
    { label: "Orders", href: "/dashboard/patient/orders", icon: <IconShoppingCart size={20} /> },
  ...
  clinician: [
    ...
    { label: "My Products", href: "/dashboard/clinician/products", icon: <IconPackage size={20} /> },
    { label: "Notifications", href: "/dashboard/notifications", icon: <IconBell size={20} /> },
  ...
  admin: [
    ...
    { label: "Consultations", href: "/dashboard/admin/consultations", icon: <IconMessageChatbot size={20} /> },
    { label: "Marketplace", href: "/dashboard/admin/products", icon: <IconPackage size={20} /> },
    { label: "Orders", href: "/dashboard/admin/orders", icon: <IconShoppingCart size={20} /> },
    { label: "Payments", href: "/dashboard/admin/payments", icon: <IconCreditCard size={20} /> },
    { label: "Content", href: "/dashboard/admin/content", icon: <IconPencil size={20} /> },
    { label: "Notifications", href: "/dashboard/admin/notifications", icon: <IconBell size={20} /> },
    { label: "Reports", href: "/dashboard/admin/reports", icon: <IconReport size={20} /> },
    { label: "Analytics", href: "/dashboard/admin/analytics", icon: <IconChartBar size={20} /> },
    { label: "Audit Logs", href: "/dashboard/admin/audit-logs", icon: <IconHistory size={20} /> },
